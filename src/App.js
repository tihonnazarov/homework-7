  ...
  return (
      <div className="App m-auto w-1/4 h-auto mt-10 p-10 bg-black bg-opacity-30 rounded-md">
        ...
        <div className="mt-10 flex gap-10">
          <input className="bg-gray-700 rounded border-black border-2 placeholder-black placeholder:text-center outline-0"
              type="text"
              placeholder="Введите задачу"
              value={taskText}
              onChange={(e) => setTaskText(e.target.value)}
          />
          <button className="p-2 rounded-2xl bg-gray-700 border-2 border-black hover:bg-gray-600" onClick={addTask}>
          ...
          {tasks.map((task, index) => (
            ...
            <span className="hover:bg-gray-600 bg-gray-700 p-2 rounded-2xl border-2 border-black inline-flex gap-5 whitespace-nowrap" onClick={() => toggleTaskCompletion(index)}>
              ...
              <svg
                ...
                <button className="p-2 rounded-2xl bg-gray-700 border-2 border-black hover:bg-gray-600" onClick={() => removeTask(index)}>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                       stroke="currentColor" className="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
